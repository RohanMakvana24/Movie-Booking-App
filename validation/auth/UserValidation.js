...
export const RagisterSchema = Joi.object({
    ...
    .messages({
      'string.pattern.base': 'Password must start with an uppercase letter, contain at least one uppercase letter, one lowercase letter, one number, and one special character',
